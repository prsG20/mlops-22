...
max_dev_acc = max(dev_acc_list)
max_test_acc = max(test_acc_list)

min_train_acc = min(train_acc_list)
min_dev_acc = min(dev_acc_list)
min_test_acc = min(test_acc_list)

mean_train = mean(train_acc_list)
mean_dev = mean(dev_acc_list)
mean_test = mean(test_acc_list)

median_train = median(train_acc_list)
median_dev = median(dev_acc_list)
median_test = median(test_acc_list)
...
print("\n")
print("Max Accuracy train set: " + str(max_train_acc))
print("Max Accuracy dev set: " + str(max_dev_acc))
print("Max Accuracy test set: " + str(max_test_acc))
print("\n")
print("Min Accuracy train set: " + str(min_train_acc))
print("Min Accuracy dev set: " + str(min_dev_acc))
print("Min Accuracy test set: " + str(min_test_acc))
print("\n")
print("Mean Accuracy train set: " + str(mean_train))
print("Mean Accuracy dev set: " + str(mean_dev))
print("Mean Accuracy test set: " + str(mean_test))
print("\n")
print("Median Accuracy train set: " + str(median_train))
print("Median Accuracy dev set: " + str(median_dev))
print("Median Accuracy test set: " + str(median_test))
print("\n")
